...
<p>Price</p>
 <input type="text" name="price" id="price" value="&#163;12.99" readonly>
 <br><br>
       Apply student discount code (up to 30% off)<br>
      <br>
      CODE: STU123
      <br>
...
function myFunction() {
    ...
    document.getElementById("price").value = "£9.09";
	return true;
}
}
</script>
<p>Membership Type</p>
 <input type="text" name="membership" id="membership" value="Student membership" readonly>
 <br>
<p>Email</p>
