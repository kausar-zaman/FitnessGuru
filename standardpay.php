...
<p>Price</p>
 <input type="text" name="price" id="price" value="&#163;15.99" readonly>
 <br><br>
    ...
    <p>
        <script>
function myFunction() {
	 var person = prompt("Enter your discount code");
	 Check = /^(?:STAN7890?)$/;
	 if(!person.match(Check)) {
         alert("Error: Invalid discount code! Please try again ");
		 document.getElementById("price").value = "Try again";
      return false;  } else {

	alert("Your discount code has been validated! ");
    document.getElementById("price").value = "£11.19";
	return true;
}
}
        </script>
    ...
    <br>
    <p>Membership Type</p>
 <input type="text" name="membership" value="Standard membership" readonly>
 <br>
<p>Email</p>
